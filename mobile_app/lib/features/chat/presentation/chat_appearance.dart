...
class ChatAppearanceCatalog {
  static const themes = <ChatThemeOption>[
    ...
    ChatThemeOption(
      id: 'classic',
      title: 'تلجرام',
      description: 'مظهر تلجرام بخلفية الرسالة متناسقة',
      color: Color(0xFF3390EC),
    ),
    ChatThemeOption(
      id: 'mint',
      title: 'زمرد',
      description: 'ألوان هادئة مع الرسالة متدرجة',
  ...
  static List<Color> _wallpaperColorsFor({
    ...
    return isDark ? wallpaper.darkColors : wallpaper.lightColors;
  }
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isDark
              ? resolved.wallpaperColors
              : resolved.wallpaperColors
                    .map((c) => Color.lerp(c, Colors.white, 0.85)!)
                    .toList(),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: -24,
            left: -18,
            child: _BackdropOrb(size: 160, color: resolved.patternColor),
          ),
          Positioned(
            top: 150,
            right: -26,
          ...
          Positioned(
            ...
            child: _BackdropOrb(
              size: 112,
              color: resolved.patternColor.withValues(
                alpha: resolved.isDarkVariant ? 0.04 : 0.03,
              ),
            ),
          ),
        ],
