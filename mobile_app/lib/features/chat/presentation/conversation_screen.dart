      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Column(
              children: [
                if (isReadOnly || (_data.pinnedMessage != null && _data.pinnedMessage!.content.trim().isNotEmpty))
...
enum _ComposerActionType { image, file, screenshot, reaction }
