...
class AppUser {
  ...
  bool get canManageItInventory =>
      isAdmin || can('canManageItInventory') || can('canExecuteItAssets');
  bool get canScanItAssets =>
      isAdmin || can('canScanItAssets') || can('canManageItAssets');
  bool get canScanItSpareParts =>
      isAdmin || can('canScanItSpareParts') || can('canManageItAssets');
  bool get canScanItInventory =>
      isAdmin || can('canScanItInventory') || canManageItInventory;
