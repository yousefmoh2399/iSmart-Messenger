...
import 'package:mobile_app/features/files/data/document_repository.dart';
import 'package:mobile_app/shared/services/local_media_storage_service.dart';
import 'package:mobile_app/core/settings/user_preferences.dart';
import 'package:mobile_app/shared/models/remote_document.dart';
...
class MockLocalMediaStorage extends LocalMediaStorageService {
  ...
  Future<Directory> documentsDirectory({String? preferredPath}) async {
    return Directory.systemTemp.createTempSync('docs_test_mobile');
  }
}
...
void main() {
  ...
  group('Mobile Document Download Deduplication and Multicast Tests', () {
    ...
    setUp(() {
      ...
      repository = DocumentRepository(
        apiClient: apiClient,
        localStorage: MockLocalMediaStorage(),
